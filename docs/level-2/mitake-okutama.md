---
title: 'OkuTama Station to Mitakesan Cable Car via Nokogiri, Odake, and Mitake (鋸山, 大岳山, 御岳山)'
description: 'Hiking route from Okutama Station (奥多摩駅) to Mitakesan Cable Car Station (御岳山駅) via Mt. Nokogiri (鋸山), Mt. Odake (大岳山), and Mt. Mitake (御岳山)'
